...
import { getUserFollowings } from "../../repository/Users.Repo.js";
...
export default function UserFollowings() {
  ...
  function fetchFollowings(pageNum) {
    setLoading(true);
    getUserFollowings(userid, pageNum, {
      onSuccess: (res) => {
  ...
  if (!loading && followings.length === 0) {
    return <NoData message="No followings found" />;
  }
